...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_MEDIA_INSERTED                  = _UxGT("SD card Inserted ;-)");
  PROGMEM Language_Str MSG_MEDIA_REMOVED                   = _UxGT("SD card Removed :-/");
  PROGMEM Language_Str MSG_MEDIA_RELEASED                  = _UxGT("Remove now SD card :-) ");
  PROGMEM Language_Str MSG_MEDIA_WAITING                   = _UxGT("Waiting for SD card...");
  PROGMEM Language_Str MSG_MEDIA_READ_ERROR                = _UxGT("SD card read error");
  PROGMEM Language_Str MSG_MEDIA_USB_REMOVED               = _UxGT("USB flash removed");
  ...
  PROGMEM Language_Str MSG_HOTEND_TOO_COLD                 = _UxGT("Hotend temp.low");
  ...
  PROGMEM Language_Str MSG_MEDIA_UPDATE                    = _UxGT("SD card Update");
  ...
  PROGMEM Language_Str MSG_MEDIA_MENU                      = _UxGT("Print from SD card");
  ...
  PROGMEM Language_Str MSG_ATTACH_MEDIA                    = _UxGT("Attach SD card");
  PROGMEM Language_Str MSG_CHANGE_MEDIA                    = _UxGT("Change SD card");
  PROGMEM Language_Str MSG_RELEASE_MEDIA                   = _UxGT("Release SD card");
  ...
  PROGMEM Language_Str MSG_INFO_THERMISTOR_MENU            = _UxGT("Temp. ctrl-NTC");
